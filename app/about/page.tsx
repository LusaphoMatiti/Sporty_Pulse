  ...
  return (
    <section className="px-4">
      ...
      <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground text-center">
        ...
        easier to work out at home. Simple gear. Practical tools. No complicated
        setups or wasted time. Whether you have 15 minutes before work or a
        short break in the evening, our products help you stay active, stretch,
        and recover—right where you are.
      </p>
      ...
      <p className="mt-12 max-w-2xl mx-auto text-center text-lg leading-8 text-muted-foreground">
        ...
        helping busy people move more, feel better, and stay consistent on their
        own terms.
      </p>
    </section>
  );
